import com.kuzmin.grpc.ProductInfoGrpc;
import com.kuzmin.grpc.ProductInfoOuterClass;
...
public class ProductInfoImpl extends ProductInfoGrpc.ProductInfoImplBase {
    private final Map productMap = new HashMap<String, ProductInfoOuterClass.Product>();
